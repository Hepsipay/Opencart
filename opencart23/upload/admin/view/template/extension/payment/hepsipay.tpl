    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-hepsipay" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-hepsipay"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="hepsipay_username" value="<?php echo $hepsipay_username; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="hepsipay_password" value="<?php echo $hepsipay_password; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="hepsipay_endpoint" value="<?php echo $hepsipay_endpoint; ?>"
                                   placeholder="<?php echo $entry_endpoint; ?>" id="input-endpoint"
                                   class="form-control"
                                   disabled="disabled" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="hepsipay_3dsecure_status">
                                <?php if($hepsipay_3dsecure_status == 1) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="hepsipay_force_3dsecure_status" id="force_3dsecure_status">
                                <?php if($hepsipay_force_3dsecure_status == 1) { ?>
                                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                                <option value="0"><?php echo $text_disabled; ?></option>
                                <?php } else { ?>
                                <option value="1"><?php echo $text_enabled; ?></option>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-test"><?php echo $entry_force_3dsecure_debit; ?>
                        </label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="hepsipay_installment_status">
                                <?php if($hepsipay_installment_status == 1) { ?>
                                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                                <option value="0"><?php echo $text_disabled; ?></option>
                                <?php } else { ?>
                                <option value="1"><?php echo $text_enabled; ?></option>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-test"><?php echo $entry_installment_commission; ?>
                        </label>
                        <div class="col-sm-10">
                            <select class="form-control" name="hepsipay_installment_commission">
                                <?php if($hepsipay_installment_commission == 1) { ?>
                                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                                <option value="0"><?php echo $text_disabled; ?></option>
                                <?php } else { ?>
                                <option value="1"><?php echo $text_enabled; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="hepsipay_total" value="<?php echo $hepsipay_total; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="hepsipay_status" id="input-status" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="hepsipay_sort_order" value="<?php echo $hepsipay_sort_order; ?>"
