  ...
  <fieldset id="payment">
      ...
      <legend><?php echo $text_credit_card; ?> <img src="<?php echo $hepsipay_logo; ?>"></legend>
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-3 required yearDiv">
            <select name="cc_year" class="form-control" id="input_cc_year">
          ...
          <div class="col-sm-6">
              <div id="installment_table_id">
                  <div class="installmet_head">
                      <div class="install_head_label add_space"><img style="display: none" class="bank_photo" data-src="<?php echo $hepsipay_banks_images; ?>" src=""></div>
...
<script type="text/javascript"><!--
  ...
  $.ajax({
    url: 'index.php?route=extension/payment/hepsipay/send',
    type: 'post',
    ...
    function refreshInstallmentOptions(){
        $.ajax({
            url: 'index.php?route=extension/payment/hepsipay/get_card_info',
            type: 'post',
            data: $('#payment :input'),
            dataType: 'json',
            ...
            success: function(json) {
                ...
                if(json['installments'].length > 0 && json['card_type'] == 'CREDIT'){
                    for($i=2; $i < json['installments'].length; $i++){
                        ...
                        if(count == 1) continue;
                        if(usedIntCount[count] != undefined) continue;
    ...
    function getExtraInstallments(selectedInstallmentCount, selectedInstallmentBank) {
        ...
        $.ajax({
            url: 'index.php?route=extension/payment/hepsipay/get_extra_installments&inst='+selectedInstallmentCount+'&bank='+selectedInstallmentBank,
            type: 'post',
            data: $('#payment :input'),
            dataType: 'json',
...
.joker {
  ...
  fieldset#payment .form-group .col-sm-6 {
      text-align: center;
  ...
  #input-cc-name, #input-cc-number, #input-cc-start-date, #input_cc_year, #input-cc-cvc{width:100% !important; max-width: 600px !important}

  fieldset#payment .form-group .col-sm-4 {
      display: none;
  }

  fieldset#payment .form-group .col-sm-2.control-label {
  ...
  fieldset#payment .form-group .col-sm-3 {
      width: 50%;
      float: left;
  }

  fieldset#payment .form-group .monthDiv {
      padding-right: 15px;
  }

  fieldset#payment .form-group .yearDiv {
      padding-left: 15px;
  }

  .form-group.installments-wrapper .col-sm-2.control-label {
      margin-bottom: 0px !important;
      float: none;
      margin-top: 20px;
  }

  .form-group.use-3d-wrapper {
      text-align: left;
  }

  .form-group.use-3d-wrapper div {
      margin: 0 !important;
  }

  .form-group.use-3d-wrapper .checkbox label{
     width: 100% !important;
  }
  ...
  @media (max-width: 480px) {
      ...
      div#installment_table_id .install_head_label {
          width: 50%;
      }
      .installment_row .install_body_label {
          width: 50%;
      }
  }
